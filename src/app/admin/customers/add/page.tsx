  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-20">
      ...
      <div className="bg-white dark:bg-slate-900 p-4 sm:p-6 rounded-sm border border-gray-100 dark:border-slate-800 shadow-sm flex items-center gap-4 transition-colors">
        ...
        <h1 className="text-lg font-black text-gray-800 dark:text-gray-100 tracking-tight transition-colors">Add New Customer</h1>
      </div>
            ...
            <div className="p-6">
              <div className="relative pl-8 space-y-10">
                ...
                <div className="relative flex items-center group">
                  ...
                  <div>
                    <h4 className="text-[11px] font-black text-gray-300 dark:text-slate-600 uppercase tracking-widest transition-colors">
