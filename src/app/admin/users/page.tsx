  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-4 sm:p-6 rounded-sm border border-gray-100 shadow-sm">
        <h1 className="text-[11px] font-black text-gray-800 uppercase tracking-[2px]">Users</h1>
        <Link 
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-50/50 border-b border-gray-100">
                ...
                <th className="px-4 py-4 text-[10px] font-black text-gray-800 uppercase tracking-widest">Role</th>
              ...
              {filteredUsers.length > 0 ? (
                  ...
                  <tr key={user.id} className="hover:bg-gray-50/50 transition-colors group">
                    ...
                    <td className="px-4 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[11px] font-black text-gray-800">{user.name}</span>
                      </div>
                    </td>
                    <td className="px-4 py-4 text-[11px] font-bold text-gray-500">{user.email}</td>
                    <td className="px-4 py-4 text-[11px] font-bold text-gray-500">{user.role}</td>
                    <td className="px-4 py-4 text-center">
                      <button 
                        onClick={() => toggleBanned(user.id)}
                        className={`w-8 h-4 rounded-full relative transition-colors ${user.banned ? "bg-red-500" : "bg-gray-200"}`}
                      >
                ...
                <tr>
                   <td colSpan={6} className="px-4 py-20 text-center">
                    <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">No users found</p>
                  </td>
                </tr>
              )}
            </tbody>
      ...
      {viewUser && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-black/40 animate-fade-in" onClick={() => setViewUser(null)}></div>
          <div className="bg-white rounded-md shadow-2xl w-full max-w-2xl relative z-10 animate-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              <div className="flex items-center gap-3">
                 ...
                 <h3 className="text-sm font-black text-gray-800 tracking-tight uppercase">User Details</h3>
              </div>
            ...
            <div className="p-6 overflow-y-auto max-h-[70vh]">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {/* Delivery Info */}
                <div className="space-y-6">
                  <h4 className="text-[10px] font-black text-blue-500 uppercase tracking-[2px] border-b border-blue-50 pb-2">Address Information</h4>
                  <div className="space-y-4">
                    {viewUser.address ? (
                      <>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-md shadow-2xl w-full max-w-md relative z-10 animate-in zoom-in-95 duration-200">
            ...
            <div className="p-8 flex flex-col items-center text-center space-y-4">
              ...
              <p className="text-sm font-black text-gray-800 tracking-tight">Are you sure to delete this user?</p>
