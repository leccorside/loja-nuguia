  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-4 sm:p-6 rounded-sm border border-gray-100 shadow-sm">
        <h1 className="text-[11px] font-black text-gray-800 uppercase tracking-[2px]">Blogs</h1>
        <Link 
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-50/50 border-b border-gray-100">
                ...
                <th className="px-4 py-4 text-[10px] font-black text-gray-800 uppercase tracking-widest min-w-[200px]">Title</th>
                <th className="px-4 py-4 text-[10px] font-black text-gray-800 uppercase tracking-widest">Category</th>
                <th className="px-4 py-4 text-[10px] font-black text-gray-800 uppercase tracking-widest">Tags</th>
                <th className="px-4 py-4 text-[10px] font-black text-gray-800 uppercase tracking-widest text-center w-24">Active</th>
                ...
                filteredBlogs.map((blog, i) => (
                  <tr key={blog.id} className="hover:bg-gray-50/50 transition-colors group">
                    ...
                    <td className="px-4 py-4">
                      <span className="text-[11px] font-black text-gray-800 line-clamp-1">{blog.title}</span>
                    </td>
                    <td className="px-4 py-4">
                      <span className="px-2 py-0.5 bg-blue-50 text-blue-500 text-[9px] font-black uppercase rounded-full">
                        {blog.category}
                      </span>
                    </td>
                    <td className="px-4 py-4">
                      <div className="flex flex-wrap gap-1">
                        {blog.tags.map(tag => (
                          <span key={tag} className="px-1.5 py-0.5 bg-gray-50 text-gray-400 text-[8px] font-bold uppercase rounded-sm border border-gray-100">
                            {tag}
                          </span>
                        ))}
                      </div>
                    ...
                    <td className="px-4 py-4 text-center">
                      <button 
                        ...
                        className={`w-8 h-4 rounded-full relative transition-colors ${blog.active ? "bg-green-500" : "bg-gray-200"}`}
                      >
