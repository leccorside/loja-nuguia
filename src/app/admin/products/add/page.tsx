    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-20">
      ...
      <div className="bg-white p-4 sm:p-6 rounded-sm border border-gray-100 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-2">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-lg font-black text-gray-800 tracking-tight">Add New Product</h1>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="relative group">
                   <div className="w-full px-4 py-2 bg-gray-50/50 border border-gray-100 rounded-sm text-xs min-h-[40px] flex flex-wrap gap-2 items-center">
                      <span className="text-gray-300 font-medium">Select Categories</span>
                   </div>
          ...
          <section id="price" className="bg-white p-6 rounded-sm border border-gray-100 shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
               <div className="space-y-2">
                  ...
                  <input type="number" placeholder="0" className="w-full px-4 py-2 bg-gray-50/50 border border-gray-100 rounded-sm text-xs font-black text-gray-800 focus:ring-1 focus:ring-green-500 outline-none" />
               </div>
               <div className="space-y-2">
               ...
               <div className="space-y-2">
                  ...
                  <input type="text" placeholder="SKU code" className="w-full px-4 py-2 bg-gray-50/50 border border-gray-100 rounded-sm text-xs font-bold text-gray-500 focus:ring-1 focus:ring-green-500 outline-none" />
               </div>
               <div className="space-y-2">
                  <label className="text-[11px] font-black text-gray-700 uppercase tracking-wider">Cost</label>
                  <input type="number" placeholder="0" className="w-full px-4 py-2 bg-gray-50/50 border border-gray-100 rounded-sm text-xs font-bold text-gray-500 focus:ring-1 focus:ring-green-500 outline-none" />
               </div>
            </div>
          </section>
          ...
          <section id="discount" className="bg-white p-6 rounded-sm border border-gray-100 shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               ...
               <div className="space-y-2">
                  ...
                  <input type="number" placeholder="0" className="w-full px-4 py-2 bg-gray-50/50 border border-gray-100 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none" />
               </div>
               <div className="space-y-2">
          ...
          <section id="shipping" className="bg-white p-6 rounded-sm border border-gray-100 shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="space-y-2">
                  ...
                  <input type="number" placeholder="1" className="w-full px-4 py-2 bg-gray-50/50 border border-gray-100 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none" />
               </div>
               <div className="space-y-2">
                  <label className="text-[11px] font-black text-gray-700 uppercase tracking-wider">Maximum Purchase Qty</label>
                  <input type="number" placeholder="10" className="w-full px-4 py-2 bg-gray-50/50 border border-gray-100 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none" />
               </div>
            </div>
          </section>
          ...
          <section id="seo" className="bg-white p-6 rounded-sm border border-gray-100 shadow-sm space-y-6">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <input type="text" placeholder="Enter meta title" className="w-full px-4 py-2 bg-gray-50/50 border border-gray-100 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none" />
              </div>
              <div className="space-y-2">
