    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-20">
      ...
      <div className="bg-white dark:bg-slate-900 p-4 sm:p-6 rounded-sm border border-gray-100 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-2 transition-colors">
        <div className="flex items-center gap-4">
          <Link href="/admin/products/all" className="p-2 hover:bg-gray-50 dark:hover:bg-slate-800 rounded-sm text-gray-400 dark:text-slate-500 hover:text-green-500 transition-colors">
            <ArrowLeftIcon className="h-5 w-5" />
          </Link>
          <h1 className="text-lg font-black text-gray-800 dark:text-gray-100 tracking-tight transition-colors">Add New Product</h1>
        </div>
        ...
        <div className="flex-1 space-y-6 w-full">
          ...
          <section id="basic-info" className="bg-white dark:bg-slate-900 p-6 rounded-sm border border-gray-100 dark:border-slate-800 shadow-sm space-y-6 transition-colors">
            <div className="flex items-center gap-2 pb-4 border-b border-gray-50 dark:border-slate-800 transition-colors">
              <DocumentTextIcon className="h-5 w-5 text-gray-400 dark:text-slate-500" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {["Physical", "Digital"].map((type) => (
                    <label key={type} className="flex items-center gap-2 cursor-pointer group">
                      <input 
                        ...
                        className="w-4 h-4 text-green-500 border-gray-300 dark:border-slate-700 focus:ring-green-500 dark:bg-slate-800"
                      />
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <div className="border border-gray-100 dark:border-slate-800 rounded-sm overflow-hidden tinymce-editor-container transition-colors">
                  <Editor
          ...
          <section id="images" className="bg-white dark:bg-slate-900 p-6 rounded-sm border border-gray-100 dark:border-slate-800 shadow-sm space-y-6 transition-colors">
            <div className="flex items-center gap-2 pb-4 border-b border-gray-50 dark:border-slate-800 transition-colors">
              <PhotoIcon className="h-5 w-5 text-gray-400 dark:text-slate-500" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <div className="flex items-center gap-2 pb-2 border-b border-gray-50 dark:border-slate-800 transition-colors">
                  <SwatchIcon className="h-4 w-4 text-gray-400 dark:text-slate-500" />
                ...
                <div className="relative group cursor-pointer">
                   <div className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs min-h-[40px] flex flex-wrap gap-2 items-center transition-colors">
                      <span className="text-gray-300 dark:text-slate-600 font-bold uppercase tracking-wider">Select Categories</span>
                   </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 pb-2 border-b border-gray-50 dark:border-slate-800 transition-colors">
                  <TagIcon className="h-4 w-4 text-gray-400 dark:text-slate-500" />
          ...
          <section id="price" className="bg-white dark:bg-slate-900 p-6 rounded-sm border border-gray-100 dark:border-slate-800 shadow-sm space-y-6 transition-colors">
            <div className="flex justify-between items-center pb-4 border-b border-gray-50 dark:border-slate-800 transition-colors">
               <div className="flex items-center gap-2">
                  <CurrencyDollarIcon className="h-5 w-5 text-gray-400 dark:text-slate-500" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
               <div className="space-y-2">
                  <label className="text-[11px] font-black text-gray-700 dark:text-slate-300 uppercase tracking-wider">Price <span className="text-red-500">*</span></label>
                  <input type="number" placeholder="0" className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs font-black text-gray-800 dark:text-gray-100 focus:ring-1 focus:ring-green-500 outline-none transition-colors" />
               </div>
               <div className="space-y-2">
                  <label className="text-[11px] font-black text-gray-700 dark:text-slate-300 uppercase tracking-wider">Stock <span className="text-red-500">*</span></label>
                  <input type="number" placeholder="0" className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs font-black text-gray-800 dark:text-gray-100 focus:ring-1 focus:ring-green-500 outline-none transition-colors" />
               </div>
               <div className="space-y-2">
                  <label className="text-[11px] font-black text-gray-700 dark:text-slate-300 uppercase tracking-wider">SKU</label>
                  <input type="text" placeholder="SKU code" className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs font-bold text-gray-500 dark:text-slate-400 focus:ring-1 focus:ring-green-500 outline-none transition-colors" />
               </div>
               <div className="space-y-2">
                  <label className="text-[11px] font-black text-gray-700 dark:text-slate-300 uppercase tracking-wider">Cost</label>
                  <input type="number" placeholder="0" className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs font-bold text-gray-500 dark:text-slate-400 focus:ring-1 focus:ring-green-500 outline-none transition-colors" />
               </div>
            </div>
          </section>
          ...
          <section id="discount" className="bg-white dark:bg-slate-900 p-6 rounded-sm border border-gray-100 dark:border-slate-800 shadow-sm space-y-6 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               <div className="space-y-2">
                  <label className="text-[11px] font-black text-gray-700 dark:text-slate-300 uppercase tracking-wider">Date Range</label>
                  <input type="text" placeholder="Select Date Range" className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none transition-colors dark:text-slate-200" />
               </div>
               <div className="space-y-2">
                  <label className="text-[11px] font-black text-gray-700 dark:text-slate-300 uppercase tracking-wider">Discount Amount</label>
                  <input type="number" placeholder="0" className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none transition-colors dark:text-slate-200" />
               </div>
               <div className="space-y-2">
                  <label className="text-[11px] font-black text-gray-700 dark:text-slate-300 uppercase tracking-wider">Percentage / Fixed</label>
                  <select className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs font-bold outline-none transition-colors text-gray-800 dark:text-gray-100">
          ...
          <section id="shipping" className="bg-white dark:bg-slate-900 p-6 rounded-sm border border-gray-100 dark:border-slate-800 shadow-sm space-y-6 transition-colors">
            <div className="flex items-center gap-2 pb-4 border-b border-gray-50 dark:border-slate-800 transition-colors">
               <TruckIcon className="h-5 w-5 text-gray-400 dark:text-slate-500" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="space-y-2">
                  <label className="text-[11px] font-black text-gray-700 dark:text-slate-300 uppercase tracking-wider">Minimum Purchase Qty</label>
                  <input type="number" placeholder="1" className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none transition-colors dark:text-slate-200" />
               </div>
               <div className="space-y-2">
                  <label className="text-[11px] font-black text-gray-700 dark:text-slate-300 uppercase tracking-wider">Maximum Purchase Qty</label>
                  <input type="number" placeholder="10" className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none transition-colors dark:text-slate-200" />
               </div>
            </div>
          </section>
               ...
               {[
                 ...
                 <div key={i} className="flex flex-col md:flex-row gap-4 items-end transition-colors">
                    <div className="flex-1 space-y-2 w-full transition-colors">
                       ...
                       <input type="number" placeholder="0" className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none transition-colors dark:text-gray-100 font-bold placeholder:text-gray-300 dark:placeholder:text-slate-600" />
                    </div>
                    <div className="w-full md:w-64 space-y-2 transition-colors">
                       <select className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs font-bold outline-none transition-colors text-gray-800 dark:text-gray-100 cursor-pointer">
                          <option className="dark:bg-slate-900">Percentage (%)</option>
          ...
          <section id="seo" className="bg-white dark:bg-slate-900 p-6 rounded-sm border border-gray-100 dark:border-slate-800 shadow-sm space-y-6 transition-colors">
            <div className="flex items-center gap-2 pb-4 border-b border-gray-50 dark:border-slate-800 transition-colors">
               <GlobeAltIcon className="h-5 w-5 text-gray-400 dark:text-slate-500" />
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <input type="text" placeholder="Enter meta title" className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none transition-colors dark:text-gray-100 font-bold placeholder:text-gray-300 dark:placeholder:text-slate-600" />
              </div>
              <div className="space-y-2">
                ...
                <textarea rows={4} className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none transition-colors resize-none dark:text-gray-100 font-bold transition-colors placeholder:text-gray-300 dark:placeholder:text-slate-600" placeholder="Enter meta description..." />
              </div>
              <div className="space-y-2">
                ...
                <div className="w-full py-10 border-2 border-dashed border-gray-200 dark:border-slate-800 rounded-sm flex flex-col items-center justify-center gap-3 hover:border-green-500 dark:hover:border-green-400 cursor-pointer transition-colors bg-gray-50/30 dark:bg-slate-800/30 group transition-colors">
                  <div className="w-10 h-10 bg-gray-100 dark:bg-slate-800 rounded-full flex items-center justify-center text-gray-400 dark:text-slate-600 group-hover:text-green-500 transition-colors">
