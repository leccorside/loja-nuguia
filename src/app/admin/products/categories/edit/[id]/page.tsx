    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-20">
      ...
      <div className="bg-white dark:bg-slate-900 p-4 sm:p-6 rounded-sm border border-gray-100 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-2 transition-colors">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-lg font-black text-gray-800 dark:text-gray-100 tracking-tight transition-colors">Update Category</h1>
        </div>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full px-4 py-2 bg-gray-50/50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 rounded-sm text-xs font-black text-gray-800 dark:text-gray-200 focus:ring-1 focus:ring-green-500 outline-none transition-all transition-colors"
                />
              </div>
            </div>
          </section>
