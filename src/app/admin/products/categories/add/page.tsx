    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-20">
      ...
      <div className="bg-white p-4 sm:p-6 rounded-sm border border-gray-100 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-2">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-lg font-black text-gray-800 tracking-tight">Add Category</h1>
        </div>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full px-4 py-2 bg-gray-50/50 border border-gray-100 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none transition-all placeholder:text-gray-300 font-medium font-bold text-gray-800"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  className="w-full px-4 py-2 bg-gray-50/50 border border-gray-100 rounded-sm text-xs focus:ring-1 focus:ring-green-500 outline-none transition-all placeholder:text-gray-300 font-medium resize-none font-bold text-gray-800"
                />
              </div>
